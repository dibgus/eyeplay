# A local-side demo of rudimentary object tracking and contour box drawing
# To see the official server implementations, see cameradetect.py
import cv2
import numpy
#dtodo function breakup
